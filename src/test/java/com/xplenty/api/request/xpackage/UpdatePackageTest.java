...
public class UpdatePackageTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        UpdatePackage cc = new UpdatePackage(PackageTest.createMockPackageForCreation());
		assertEquals(Xplenty.Resource.UpdatePackage.format(String.valueOf(666)), cc.getEndpoint());
		assertEquals(Xplenty.Resource.UpdatePackage.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.UpdatePackage.name + ": error parsing response object", e.getMessage());
		}
