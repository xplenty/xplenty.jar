 ...
 *
 */
public class RunPackageValidationTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        RunPackageValidation cc = new RunPackageValidation(666);
		assertEquals(Xplenty.Resource.RunPackageValidation.format(String.valueOf(666)), cc.getEndpoint());
		assertEquals(Xplenty.Resource.RunPackageValidation.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.RunPackageValidation.name + ": error parsing response object", e.getMessage());
		}
