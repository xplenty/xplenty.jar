 ...
 *
 */
public class DeletePackageTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        DeletePackage cc = new DeletePackage(666);
		assertEquals(Xplenty.Resource.DeletePackage.format(String.valueOf(666)), cc.getEndpoint());
		assertEquals(Xplenty.Resource.DeletePackage.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.DeletePackage.name + ": error parsing response object", e.getMessage());
		}
