...
public class AccountInfoTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        AccountInfo cc = new AccountInfo("superunique");
		assertEquals(Xplenty.Resource.Account.format("superunique"), cc.getEndpoint());
		assertEquals(Xplenty.Resource.Account.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.Account.name + ": error parsing response object", e.getMessage());
		}
