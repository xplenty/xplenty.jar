 ...
 *
 */
public class UpdateAccountTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        Account account = new Account("superunique");
        UpdateAccount cc = new UpdateAccount(account);
		assertEquals(Xplenty.Resource.UpdateAccount.format("superunique"), cc.getEndpoint());
		assertEquals(Xplenty.Resource.UpdateAccount.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.UpdateAccount.name + ": error parsing response object", e.getMessage());
		}
