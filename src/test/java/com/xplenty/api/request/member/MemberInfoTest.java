...
public class MemberInfoTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        MemberInfo cc = new MemberInfo(666);
		assertEquals(Xplenty.Resource.Member.format(String.valueOf(666)), cc.getEndpoint());
		assertEquals(Xplenty.Resource.Member.name, cc.getName());
	...
	public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
		...
		try {
			...
			assertEquals(Xplenty.Resource.Member.name + ": error parsing response object", e.getMessage());
		}
