 ...
 * Time: 19:43
 */
public class PingWebHookTest extends TestCase {
    @Before
    public void setUp() {
    ...
    public void testIntegrity() {
        ...
        PingWebHook cc = new PingWebHook(1L);
        assertEquals(Xplenty.Resource.PingWebHook.format("1"), cc.getEndpoint());
        assertEquals(Xplenty.Resource.PingWebHook.name, cc.getName());
    ...
    public void testValidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
        ...
        PingWebHook cc = new PingWebHook(666);
    ...
    public void testInvalidResponseHandling() throws JsonProcessingException, UnsupportedEncodingException {
        ...
        try {
            ...
            assertEquals(Xplenty.Resource.PingWebHook.name + ": error parsing response object", e.getMessage());
        }
