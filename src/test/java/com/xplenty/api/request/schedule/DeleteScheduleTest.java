...
import com.xplenty.api.request.schedule.DeleteSchedule;
 ...
 *
 */
public class DeleteScheduleTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        DeleteSchedule cs = new DeleteSchedule(666);
		assertEquals(Xplenty.Resource.RemoveSchedule.format(String.valueOf(666)), cs.getEndpoint());
		assertEquals(Xplenty.Resource.RemoveSchedule.name, cs.getName());
		assertEquals(Http.Method.DELETE, cs.getHttpMethod());
