...
import com.xplenty.api.request.schedule.CreateSchedule;
...
public class CreateScheduleTest extends TestCase {
	...
	public void testIntegrity() {
        ...
        CreateSchedule cs = new CreateSchedule(ScheduleTest.createMockSchedule(new Date()));
		assertEquals(Xplenty.Resource.CreateSchedule.value, cs.getEndpoint());
		assertEquals(Xplenty.Resource.CreateSchedule.name, cs.getName());
